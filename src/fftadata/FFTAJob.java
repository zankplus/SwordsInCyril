...
{						//Name			HP			MP			WAtk			WDef		MPow		MRes		Speed
	...
	THIEF_H			(	"Thief",		33,	6.6,    15,  1.1,    76,  7.6,    76,  7.6,    76,  7.6,    64,  6.4,   110,  1.8, 4, 3, 65, 10, FFTACommand.STEAL, 			new EquipType[] {EquipType.KNIFE, EquipType.HAT, EquipType.CLOTHING}),
	...
	WHITE_MAGE_H	(	"White Mage",	30,	6.1,    40,  4.8,    60,  6.2,    73,  7.3,    84,  8.4,    80,  8.2,   108,  1.2, 3, 2, 40, 10, FFTACommand.WHITE_MAGIC, 		new EquipType[] {EquipType.STAFF, EquipType.HAT, EquipType.CLOTHING, EquipType.ROBE}),
	BLACK_MAGE_H	(	"Black Mage",	28,	5.6,    36,  4.4,    64,  6.4,    68,  6.8,    88,  8.8,    96,  9.6,    96,  1.1, 3, 2, 35, 10, FFTACommand.BLACK_MAGIC, 		new EquipType[] {EquipType.ROD, EquipType.HAT, EquipType.CLOTHING, EquipType.ROBE}),
	ILLUSIONIST_H	(	"Illusionist",	26,	5.2,    38,  7.1,    60,  6.1,    64,  6.4,    92,  9.2,    84,  8.4,    89,  0.9, 3, 2, 30, 10, FFTACommand.PHANTASM_SKILL, 	new EquipType[] {EquipType.ROD, EquipType.HAT, EquipType.CLOTHING, EquipType.ROBE}),
	...
	ARCHER_H		(	"Archer",		36,	7.2,    18,  1.1,    72,  7.2,    72,  7.2,    64,  6.4,    80,  8.1,   106,  1.4, 4, 2, 50, 10, FFTACommand.AIM, 				new EquipType[] {EquipType.BOW, EquipType.HAT, EquipType.CLOTHING}),
	...
	THIEF_M			(	"Thief",		29,	5.8,    12,  2.2,    73,  7.3,    84,  8.4,    68,  6.8,    76,  7.6,   110,  1.9, 4, 3, 70, 10, FFTACommand.STEAL,				new EquipType[] {EquipType.KNIFE, EquipType.HAT, EquipType.CLOTHING}),
	...
	BLACK_MAGE_M	(	"Black Mage",	27,	5.4,    28,  4.8,    57,  5.7,    76,  7.6,    84,  8.4,    97,  9.7,    96,  1.1, 3, 2, 35, 10, FFTACommand.BLACK_MAGIC, 		new EquipType[] {EquipType.ROD, EquipType.HAT, EquipType.CLOTHING, EquipType.ROBE}),
	TIME_MAGE_M		(	"Time Mage",	26,	5.2,    22,  3.6,    56,  5.6,    76,  7.6,    92,  9.2,    94,  9.4,    98,  1.2, 3, 2, 30, 10, FFTACommand.TIME_MAGIC, 		new EquipType[] {EquipType.ROD, EquipType.HAT, EquipType.CLOTHING, EquipType.ROBE}),
	WHITE_MAGE_N	(	"White Mage",	29,	5.8,    52,  5.6,    57,  5.7,    73,  7.3,    88,  8.8,    84,  8.4,   108,  1.1, 3, 2, 40, 10, FFTACommand.WHITE_MAGIC, 		new EquipType[] {EquipType.STAFF, EquipType.HAT, EquipType.CLOTHING, EquipType.ROBE}),
	BLACK_MAGE_N	(	"Black Mage",	27,	5.4,    42,  5.2,    62,  6.2,    68,  6.8,    92,  9.2,   100, 10.2,    96,  0.9, 3, 2, 35, 10, FFTACommand.BLACK_MAGIC, 		new EquipType[] {EquipType.ROD, EquipType.HAT, EquipType.CLOTHING, EquipType.ROBE}),
	TIME_MAGE_N		(	"Time Mage",	26,	5.2,    36,  3.6,    56,  5.6,    68,  6.8,   100, 10.2,    96,  9.6,    98,  1.2, 3, 2, 30, 10, FFTACommand.TIME_MAGIC, 		new EquipType[] {EquipType.ROD, EquipType.HAT, EquipType.CLOTHING, EquipType.ROBE}),
	ILLUSIONIST_N	(	"Illusionist",	25,	5.1,    46,  7.6,    57,  5.7,    64,  6.4,    96,  9.6,    88,  8.8,    89,  0.8, 3, 2, 30, 10, FFTACommand.PHANTASM_SKILL, 	new EquipType[] {EquipType.ROD, EquipType.HAT, EquipType.CLOTHING, EquipType.ROBE}),
	ALCHEMIST		(	"Alchemist",	30,	6.1,    48,  8.4,    59,  5.9,    65,  6.5,    92,  9.2,    96,  9.6,    92,  0.9, 3, 3, 35, 10, FFTACommand.ALCHEMY_PLUS,	 	new EquipType[] {EquipType.MACE, EquipType.HAT, EquipType.CLOTHING}),
	...
	WHITE_MAGE_V	(	"White Mage",	30,	6.2,    31,  4.8,    62,  6.2,    72,  7.2,    88,  8.8,    76,  7.6,   115,  1.2, 3, 2, 40, 10, FFTACommand.WHITE_MAGIC,		new EquipType[] {EquipType.STAFF, EquipType.RIBBON, EquipType.HAT, EquipType.CLOTHING, EquipType.ROBE}),
	...
	ARCHER_V		(	"Archer",		36,	7.2,    14,  1.6,    80,  8.1,    68,  6.8,    72,  7.2,    76,  7.6,   112,  1.6, 4, 2, 50, 10, FFTACommand.AIM, 				new EquipType[] {EquipType.BOW, EquipType.RIBBON, EquipType.HAT, EquipType.CLOTHING}),
