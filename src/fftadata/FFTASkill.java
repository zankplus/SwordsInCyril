...
public enum FFTASkill implements Serializable
{
	...
	ESUNA			("Esuna", 			18,  0, 4, 0, 1, 2, Targeting.FREE_SELECT,	Element.NULL,		true,	false,	false,	true,	false,	false,	false,	true,	true,	true,	false,	false, 	true,	new SkillEffect[] {SkillEffect.ESUNA_EFFECT}),
	...
	AUTO_LIFE		("Auto-Life", 		16,  0, 4, 0, 0, 0, Targeting.FREE_SELECT,	Element.HOLY,		true,	false,	false,	true,	false,	false,	false,	true,	true,	true,	false,	false,	true,	new SkillEffect[] {SkillEffect.ADD_AUTO_LIFE}),
	SHELL			("Shell", 			 6,  0, 4, 0, 1, 2, Targeting.FREE_SELECT,	Element.NULL,		true,	false,	false,	true,	false,	false,	false,	true,	true,	true,	false,	false,	true,	new SkillEffect[] {SkillEffect.ADD_SHELL}),
	PROTECT			("Protect", 		 6,  0, 4, 0, 1, 2, Targeting.FREE_SELECT,	Element.NULL,		true,	false,	false,	true,	false,	false,	false,	true,	true,	true,	false,	false,	true,	new SkillEffect[] {SkillEffect.ADD_PROTECT}),
	...
	BARRIER			("Barrier", 		10,  0, 3, 0, 0, 0, Targeting.FREE_SELECT, Element.NULL,		true,	false,	false,	true,	false,	false,	false,	true,	true,	true,	false,	false,	true,	new SkillEffect[] {SkillEffect.ADD_SHELL, SkillEffect.ADD_PROTECT}),
	...
	SLEEP			("Sleep", 			10,  0, 4, 0, 1, 2, Targeting.FREE_SELECT,	Element.NULL,		true,	false,	false,	true,	false,	false,	false,	true,	true,	true,	true,	false,	true,	new SkillEffect[] {SkillEffect.ADD_SLEEP}),
	...
	QUICKEN			("Quicken", 		24,  0, 3, 0, 0, 0, Targeting.FREE_SELECT,	Element.NULL,		true,	false,	false, false,	false,	false,	false,	true,	true,	true,	false,	false,	true,	new SkillEffect[] {SkillEffect.ADD_QUICK}),
	...
	HASTE			("Haste", 			24,  0, 3, 0, 0, 0, Targeting.FREE_SELECT,	Element.NULL,		true,	false,false,	true,	false,	false,	false,	true,	true,	true,	false,	false,	true,	new SkillEffect[] {SkillEffect.ADD_HASTE}),
	...
	FIRE_WHIP		("Fire Whip", 		12, 30, 4, 0, 0, 0, Targeting.FREE_SELECT,	Element.FIRE,		true,	false,	false,	true,	false,	false,	true,	false,	true,	true,	true,	true,	true,	new SkillEffect[] {SkillEffect.REGULAR_DAMAGE, SkillEffect.EFF1DEP_ADD_DISABLE}),
	...
	EVIL_GAZE		("Evil Gaze", 		12, 30, 4, 0, 0, 0, Targeting.FREE_SELECT,	Element.DARK,		true,	false,	false,	true,	false,	false,	true,	false,	true,	true,	true,	true,	false,	new SkillEffect[] {SkillEffect.REGULAR_DAMAGE, SkillEffect.EFF1DEP_ADD_CONFUSE}),
	HEAVY_DUST		("Heavy Dust",		12, 30, 4, 0, 0, 0, Targeting.FREE_SELECT,	Element.EARTH,		true,	false,	false,	true,	false,	false,	true,	false,	true,	true,	true,	true,	true,	new SkillEffect[] {SkillEffect.REGULAR_DAMAGE, SkillEffect.EFF1DEP_ADD_IMMOBILIZE}),
	...
	DEATH			("Death", 			36,  0, 3, 0, 0, 0, Targeting.FREE_SELECT,	Element.DARK,		true,	false,	false,	false,	false,	false,	false,	false,	true,	true,	true,	false,	true,	new SkillEffect[] {SkillEffect.ADD_DEATH}),
	...
	TOAD			("Toad", 			36,  0, 3, 0, 0, 0, Targeting.FREE_SELECT,	Element.NULL,		true,	false, 	false,	true,	false,	false,	false,	false,	true,	true,	true,	false,	true,	new SkillEffect[] {SkillEffect.ADD_FROG}),
	UNICORN			("Unicorn", 		12, 40, 4, 0, 2, 2, Targeting.FREE_SELECT,	Element.HOLY,		true,	false,	false,	true,	false,	false,	false,	false,	true,	true,	false,	false,	true,	new SkillEffect[] {SkillEffect.HEALING_1X, SkillEffect.ESUNA_EFFECT}),
	...
	MADEEN			("Madeen", 			36, 52, 4, 0, 2, 2, Targeting.FREE_SELECT,	Element.HOLY,		true,	false, 	false, 	true, 	false, 	false, 	true, 	false, 	true, 	true, 	true, 	true, 	true, 	new SkillEffect[] {SkillEffect.REGULAR_DAMAGE}),
	FIRST_AID		("First Aid",		 0, 25, 0, 0, 0, 0, Targeting.FREE_SELECT,	Element.NULL,		true,	false,	false,	true,	false,	true,	false,	false,	false,	true,	false,	false,	true,	new SkillEffect[] {SkillEffect.HEALING_1X, SkillEffect.ESUNA_EFFECT}),
	...
	PROVOKE			("Provoke", 		 0,  0, 1, 2, 0, 0, Targeting.FREE_SELECT,	Element.NULL,		true,	false,	false,	false,	false,	false,	false,	false,	false,	true,	false,	false,	false,	new SkillEffect[] {SkillEffect.ADD_BERSERK}),
	...
	CHAKRA			("Chakra", 			 0, 35, 0, 0, 0, 0, Targeting.FREE_SELECT,	Element.NULL,		true,	false,	false,	true,	false,	true,	false,	false,	false,	true,	false,	false,	true,	new SkillEffect[] {SkillEffect.HEALING_1X, SkillEffect.ESUNA_EFFECT}),
	...
	MOG_AID			("Mog Aid", 		 0, 35, 0, 0, 0, 0, Targeting.FREE_SELECT,	Element.NULL,		true,	false,	false,	true,	false,	true,	false,	false,	false,	true,	false,	false,	true,	new SkillEffect[] {SkillEffect.HEALING_1X, SkillEffect.ESUNA_EFFECT}),
	...
	CHECKMATE		("Checkmate", 		 0,  0, 0, 0, 0, 0, Targeting.AS_WEAPON,	Element.NULL,		true,	false,	true,	false,	false,	true,	true,	false,	false,	true,	false,	false,	true,	new SkillEffect[] {SkillEffect.ADD_DOOM}),
	...
	WOOD_VEIL		("Wood Veil", 		 4, 15, 4, 0, 0, 0, Targeting.FREE_SELECT,	Element.NULL,		true,	false,	false,	false,	false,	false,	true,	false,	false,	true,	false,	true,	true,	new SkillEffect[] {SkillEffect.REGULAR_DAMAGE, SkillEffect.EFF1DEP_ADD_IMMOBILIZE}),
	FIRE_VEIL		("Fire Veil", 		 4, 15, 4, 0, 0, 0, Targeting.FREE_SELECT,	Element.NULL,		true,	false,	false,	false,	false,	false,	true,	false,	false,	true,	false,	true,	false,	new SkillEffect[] {SkillEffect.REGULAR_DAMAGE, SkillEffect.EFF1DEP_ADD_CONFUSE}),
	...
	OBLIVION		("Oblivion", 		24,  0, 1, 2, 0, 0, Targeting.FREE_SELECT,	Element.NULL,		true,	false,	false,	false,	false,	false,	false,	false,	false,	true,	false,	false,	true,	new SkillEffect[] {SkillEffect.ADD_ADDLE}),
	SHADOWBIND		("Shadowbind", 		12,  0, 1, 2, 0, 0, Targeting.FREE_SELECT,	Element.NULL,		true,	false,	false,	false,	false,	true,	false,	false,	false,	true,	false,	false,	true,	new SkillEffect[] {SkillEffect.ADD_STOP}),
	LAST_BREATH		("Last Breath", 	32,  0, 1, 2, 0, 0, Targeting.FREE_SELECT,	Element.NULL,		true,	false,	false,	false,	false,	true,	false,	false,	false,	true,	false,	false,	true,	new SkillEffect[] {SkillEffect.ADD_DEATH}),
	...
	NIGHTMARE		("Nightmare", 		18,  0, 1, 2, 0, 0, Targeting.FREE_SELECT,	Element.NULL,		true,	false,	false,	false,	false,	true,	false,	false,	false,	true,	false,	false,	true,	new SkillEffect[] {SkillEffect.ADD_DOOM, SkillEffect.ADD_SLEEP}),
	...
	AIM_LEGS		("Aim: Legs", 		 0,  0, 0, 0, 0, 0, Targeting.AS_WEAPON,	Element.NULL,		true,	false,	false,	false,	false,	true,	false,	false,	false,	true,	false,	false,	true,	new SkillEffect[] {SkillEffect.ADD_IMMOBILIZE}),
	AIM_ARM			("Aim: Arm", 		 0,  0, 0, 0, 0, 0, Targeting.AS_WEAPON,	Element.NULL,		true,	false,	false,	false,	false,	true,	false,	false,	false,	true,	false,	false,	true,	new SkillEffect[] {SkillEffect.ADD_DISABLE}),
	CUPID			("Cupid", 			 0,  0, 0, 0, 0, 0, Targeting.AS_WEAPON,	Element.NULL,		true,	false,	false,	false,	false,	true,	false,	false,	false,	true,	false,	false,	true,	new SkillEffect[] {SkillEffect.ADD_CHARM}),
	...
	BLACKOUT		("Blackout", 		 0,  0, 0, 0, 0, 0, Targeting.AS_WEAPON,	Element.NULL,		true,	false,	false,	false,	false,	true,	false,	false,	false,	true,	false,	false,	true,	new SkillEffect[] {SkillEffect.ADD_BLIND}),	
	...
	ADDLE			("Addle", 			 0,  0, 0, 0, 0, 0, Targeting.AS_WEAPON,	Element.NULL,		true,	false,	false,	false,	false,	true,	false,	false,	false,	true,	false,	false,	true,	new SkillEffect[] {SkillEffect.ADD_ADDLE}),
	...
	RING			("Ring", 			 0,  0, 4, 0, 0, 0, Targeting.FREE_SELECT,	Element.NULL,		true,	false,	false,	false,	false,	true,	false,	false,	false,	true,	false,	false,	true,	new SkillEffect[] {SkillEffect.ADD_STOP}),
	FIREBOMB		("Firebomb", 		 0, 30, 4, 0, 0, 0, Targeting.FREE_SELECT,	Element.FIRE,		true,	false,	true,	false,	false,	true,	true,	false,	false,	true,	false,	false,	false,	new SkillEffect[] {SkillEffect.REGULAR_DAMAGE, SkillEffect.EFF1DEP_ADD_BERSERK}),
	BALL			("Ball", 			 0,  0, 4, 0, 0, 0, Targeting.FREE_SELECT,	Element.NULL,		true,	false,	false,	false,	false,	true,	false,	false,	false,	true,	false,	false,	false,	new SkillEffect[] {SkillEffect.ADD_CONFUSE}),
	DAGGER			("Dagger", 			 0, 35, 4, 0, 0, 0, Targeting.FREE_SELECT,	Element.NULL,		true,	false,	true,	false,	false,	true,	true,	false,	false,	true,	false,	false,	true,	new SkillEffect[] {SkillEffect.REGULAR_DAMAGE, SkillEffect.EFF1DEP_ADD_DISABLE}),		
	SMILE			("Smile", 			 0,  0, 4, 0, 0, 0, Targeting.FREE_SELECT,	Element.NULL,		true,	false,	false,	false,	false,	true,	false,	false,	false,	true,	false,	false,	true,	new SkillEffect[] {SkillEffect.ADD_QUICK}),
	...
	DEATH_SICKLE	("Death Sickle", 	 0,  0, 0, 0, 0, 0, Targeting.AS_WEAPON,	Element.NULL,		true,	false,	false,	false,	false,	true,	false,	false,	false,	true,	false,	false,	true,	new SkillEffect[] {SkillEffect.ADD_DOOM}),
	...
	SHEEP_COUNT		("Sheep Count", 	 8,  0, 4, 0, 1, 2, Targeting.FREE_SELECT,	Element.NULL,		true,	false,	false,	true,	false,	false,	false,	false,	false,	true,	false,	false,	true,	new SkillEffect[] {SkillEffect.ADD_SLEEP}),
	HUNDY_WOOL		("100% Wool", 		 8,  0, 0, 0, 0, 0, Targeting.FREE_SELECT,	Element.NULL,		true,	false,	false,	true,	false,	false,	false,	false,	false,	true,	false,	false,	true,	new SkillEffect[] {SkillEffect.ADD_SHELL, SkillEffect.ADD_PROTECT}),
	...
	TAIL_WAG		("Tail Wag", 		 8,  0, 1, 2, 0, 0, Targeting.FREE_SELECT,	Element.NULL,		true,	false,	false,	false,	false,	false,	false,	false,	false,	true,	false,	false,	false,	new SkillEffect[] {SkillEffect.ADD_CHARM}),
	...
	FROGSONG		("Frogsong", 		18,  0, 4, 0, 0, 0, Targeting.FREE_SELECT,	Element.NULL,		true,	false,	false,	false,	false,	false,	false,	false,	false,	true,	false,	false,	true,	new SkillEffect[] {SkillEffect.ADD_FROG}),
	FRIEND			("Friend", 			0, 0, 0, 0, 0, 0, null, null, true,	false, false, false, false, false, false, false, false, false, false, false, false, null),
	CATNIP			("Catnip", 			12,  0, 1, 2, 0, 0, Targeting.FREE_SELECT,	Element.NULL,		true,	false,	false,	false,	false,	false,	false,	false,	false,	true,	false,	false,	false,	new SkillEffect[] {SkillEffect.ADD_BERSERK}),
	...
	CONFUSHOT		("Confushot", 		 0, -1, 0, 0, 0, 0, Targeting.AS_WEAPON,	Element.AS_WEAPON,	true,	false,	true,	false,	false,	true,	true,	false,	false,	true,	false,	false,	false,	new SkillEffect[] {SkillEffect.REGULAR_DAMAGE, SkillEffect.EFF1DEP_ADD_CONFUSE}),
	CHARMSHOT		("Charmshot", 		 0, -1, 0, 0, 0, 0, Targeting.AS_WEAPON,	Element.AS_WEAPON,	true,	false,	true,	false,	false,	true,	true,	false,	false,	true,	false,	false,	false,	new SkillEffect[] {SkillEffect.REGULAR_DAMAGE, SkillEffect.EFF1DEP_ADD_CHARM}),
	...
	STOPSHOT		("Stopshot", 		 0, -1, 0, 0, 0, 0, Targeting.AS_WEAPON,	Element.AS_WEAPON,	true,	false,	true,	false,	false,	true,	true,	false,	false,	true,	false,	false,	true,	new SkillEffect[] {SkillEffect.REGULAR_DAMAGE, SkillEffect.EFF1DEP_ADD_STOP}),
	...
	POISON_FROG		("Poison Frog", 	 0,  0, 3, 0, 0, 0, Targeting.FREE_SELECT,	Element.NULL,		true,	false,	false,	false,	false,	true,	false,	false,	false,	false,	false,	false,	true,	new SkillEffect[] {SkillEffect.ADD_POISON, SkillEffect.EFF1DEP_ADD_FROG}),
	KISS			("Kiss", 			 0,  0, 1, 2, 0, 0, Targeting.FREE_SELECT,	Element.NULL,		true,	false,	false,	false,	false,	true,	false,	false,	false,	false,	false,	false,	false,	new SkillEffect[] {SkillEffect.ADD_DOOM, SkillEffect.EFF1DEP_ADD_CHARM}),
