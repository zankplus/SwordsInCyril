...
public enum FFTASkill implements Serializable
{
	...
	ESUNA			("Esuna", 			18,  0, 4, 0, 1, 2, Targeting.FREE_SELECT,	Element.NULL,		true,	false,	true,	true,	false,	true,	false,	false,	false,	true,	true,	true,	false,	false,	true,	new SkillEffect[] {SkillEffect.ESUNA_EFFECT}),
	LIFE			("Life", 			10,  0, 4, 0, 0, 0, Targeting.FREE_SELECT,	Element.HOLY,		false,	true,	true,	true,	false,	false,	false,	false,	false,	true,	true,	true,	false,	false,	true,	new SkillEffect[] {SkillEffect.REVIVE_HALF_HP}),
	FULL_LIFE		("Full-Life", 		20,  0, 4, 0, 0, 0, Targeting.FREE_SELECT,	Element.HOLY,		false,	true,	true,	true,	false,	false,	false,	false,	false,	true,	true,	true,	false,	false,	true,	new SkillEffect[] {SkillEffect.REVIVE_FULL_HP}),
	AUTO_LIFE		("Auto-Life", 		16,  0, 4, 0, 0, 0, Targeting.FREE_SELECT,	Element.HOLY,		true,	false,	true,	true,	false,	true,	false,	false,	false,	true,	true,	true,	false,	false,	true,	new SkillEffect[] {SkillEffect.ADD_AUTO_LIFE}),
	SHELL			("Shell", 			 6,  0, 4, 0, 1, 2, Targeting.FREE_SELECT,	Element.NULL,		true,	false,	true,	true,	false,	true,	false,	false,	false,	true,	true,	true,	false,	false,	true,	new SkillEffect[] {SkillEffect.ADD_SHELL}),
	PROTECT			("Protect", 		 6,  0, 4, 0, 1, 2, Targeting.FREE_SELECT,	Element.NULL,		true,	false,	true,	true,	false,	true,	false,	false,	false,	true,	true,	true,	false,	false,	true,	new SkillEffect[] {SkillEffect.ADD_PROTECT}),
	DISPEL			("Dispel", 			12,  0, 3, 0, 1, 2, Targeting.FREE_SELECT,	Element.NULL,		true,	false,	true,	true,	false,	true,	false,	false,	false,	false,	true,	true,	false,	false,	true,	new SkillEffect[] {SkillEffect.DISPEL_EFFECT}),
	HOLY			("Holy", 			32, 50, 3, 0, 1, 1, Targeting.FREE_SELECT,	Element.HOLY,		true,	false,	true,	true,	false,	true,	false,	false,	true,	false,	true,	true,	true,	true,	true,	new SkillEffect[] {SkillEffect.REGULAR_DAMAGE}),
	BARRIER			("Barrier", 		10,  0, 3, 0, 0, 0, Targeting.FREE_SELECT, Element.NULL,		true,	false,	true,	true,	false,	true,	false,	false,	false,	true,	true,	true,	false,	false,	true,	new SkillEffect[] {SkillEffect.ADD_SHELL, SkillEffect.ADD_PROTECT}),
	...
	BIO				("Bio", 			12, 45, 3, 0, 2, 1, Targeting.FREE_SELECT,	Element.NULL,		true,	false,	true,	true,	false,	true,	false,	false,	true,	false,	true,	true,	true,	true,	true,	new SkillEffect[] {SkillEffect.REGULAR_DAMAGE, SkillEffect.EFF1DEP_ADD_POISON}),
	ULTIMA_BLOW		("Ultima Blow", 	60, -1, 0, 0, 0, 0, Targeting.AS_WEAPON,	Element.AS_WEAPON,	true,	false,	true,	true,	true,	false,	false,	true,	true,	false,	false,	false,	true,	true,	true,	new SkillEffect[] {SkillEffect.TRIPLE_DAMAGE}),
	FIRE			("Fire",			 6, 30, 4, 0, 1, 1, Targeting.FREE_SELECT,	Element.FIRE,		true,	false,	true,	true,	false,	true,	false,	false,	true,	true,	true,	true,	true,	true,	true,	new SkillEffect[] {SkillEffect.REGULAR_DAMAGE}),
	FIRA			("Fira",			12, 40, 4, 0, 1, 2, Targeting.FREE_SELECT,	Element.FIRE,		true,	false,	true,	true,	false,	true,	false,	false,	true,	true,	true,	true,	true,	true,	true,	new SkillEffect[] {SkillEffect.REGULAR_DAMAGE}),
	FIRAGA			("Firaga",			24, 50, 4, 0, 1, 3, Targeting.FREE_SELECT,	Element.FIRE,		true,	false,	true,	true,	false,	true,	false,	false,	true,	true,	true,	true,	true,	true,	true,	new SkillEffect[] {SkillEffect.REGULAR_DAMAGE}),
	THUNDER			("Thunder", 		 6, 30, 4, 0, 1, 1, Targeting.FREE_SELECT,	Element.LIGHTNING,	true,	false,	true,	true,	false,	true,	false,	false,	true,	true,	true,	true,	true,	true,	true,	new SkillEffect[] {SkillEffect.REGULAR_DAMAGE}),
	THUNDARA		("Thundara",		12, 40, 4, 0, 1, 2, Targeting.FREE_SELECT,	Element.LIGHTNING,	true,	false,	true,	true,	false,	true,	false,	false,	true,	true,	true,	true,	true,	true,	true,	new SkillEffect[] {SkillEffect.REGULAR_DAMAGE}),
	THUNDAGA		("Thundaga", 		24, 50, 4, 0, 1, 3, Targeting.FREE_SELECT,	Element.LIGHTNING,	true,	false,	true,	true,	false,	true,	false,	false,	true,	true,	true,	true,	true,	true,	true,	new SkillEffect[] {SkillEffect.REGULAR_DAMAGE}),
	BLIZZARD		("Blizzard", 		 6, 30, 4, 0, 1, 1, Targeting.FREE_SELECT,	Element.ICE,		true,	false,	true,	true,	false,	true,	false,	false,	true,	true,	true,	true,	true,	true,	true,	new SkillEffect[] {SkillEffect.REGULAR_DAMAGE}),
	...
	SHINING_AIR		("Shining Air", 	12, 30, 4, 0, 0, 0, Targeting.FREE_SELECT,	Element.WIND,		true,	false,	true,	true,	false,	true,	false,	false,	true,	false,	true,	true,	true,	true,	true,	new SkillEffect[] {SkillEffect.REGULAR_DAMAGE, SkillEffect.EFF1DEP_ADD_BLIND}),
	EVIL_GAZE		("Evil Gaze", 		12, 30, 4, 0, 0, 0, Targeting.FREE_SELECT,	Element.DARK,		true,	false,	true,	true,	false,	true,	false,	false,	true,	false,	true,	true,	true,	true,	false,	new SkillEffect[] {SkillEffect.REGULAR_DAMAGE, SkillEffect.EFF1DEP_ADD_CONFUSE}),
	HEAVY_DUST		("Heavy Dust",		12, 30, 4, 0, 0, 0, Targeting.FREE_SELECT,	Element.EARTH,		true,	false,	true,	true,	false,	true,	false,	false,	true,	false,	true,	true,	true,	true,	true,	new SkillEffect[] {SkillEffect.REGULAR_DAMAGE, SkillEffect.EFF1DEP_ADD_IMMOBILIZE}),
	SLIPRAIN		("Sliprain", 		12, 30, 4, 0, 0, 0, Targeting.FREE_SELECT,	Element.WATER,		true,	false,	true,	true,	false,	true,	false,	false,	true,	false,	true,	true,	true,	true,	true,	new SkillEffect[] {SkillEffect.REGULAR_DAMAGE, SkillEffect.EFF1DEP_ADD_SLOW}),
	...
	ASTRA			("Astra", 			8,  0, 4, 0, 1, 2, Targeting.FREE_SELECT,	Element.NULL,		true,	false,	true,	true,	false,	true,	false,	false,	false,	false,	true,	true,	false,	false,	true,	new SkillEffect[] {SkillEffect.ADD_ASTRA}),
	RASP			("Rasp", 			24, 60, 3, 0, 1, 1, Targeting.FREE_SELECT,	Element.NULL,		true,	false,	true,	true,	false,	false,	true,	false,	false,	false,	true,	true,	true,	false,	true,	new SkillEffect[] {SkillEffect.MP_DAMAGE}),
	DEATH			("Death", 			36,  0, 3, 0, 0, 0, Targeting.FREE_SELECT,	Element.DARK,		true,	false,	true,	true,	false,	false,	false,	false,	false,	false,	true,	true,	true,	false,	true,	new SkillEffect[] {SkillEffect.ADD_DEATH}),
	METEOR			("Meteor", 			40, 50, 3, 0, 1, 2, Targeting.FREE_SELECT,	Element.NULL,		true,	false,	true,	true,	false,	true,	false,	false,	true,	false,	true,	true,	true,	true,	true,	new SkillEffect[] {SkillEffect.REGULAR_DAMAGE}),
	FLARE			("Flare", 			36, 65, 3, 0, 0, 0, Targeting.FREE_SELECT,	Element.NULL,		true,	false,	true,	true,	false,	false,	false,	false,	true,	false,	true,	true,	true,	true,	true,	new SkillEffect[] {SkillEffect.REGULAR_DAMAGE}),
	POISON			("Poison", 			10,  0, 4, 0, 1, 2, Targeting.FREE_SELECT,	Element.DARK,		true,	false,	true,	true,	false,	true,	false,	false,	false,	false,	true,	true,	true,	false,	true,	new SkillEffect[] {SkillEffect.ADD_POISON}),
	TOAD			("Toad", 			36,  0, 3, 0, 0, 0, Targeting.FREE_SELECT,	Element.NULL,		true,	false,	true,	true,	false,	true,	false,	false,	false,	false,	true,	true,	true,	false,	true,	new SkillEffect[] {SkillEffect.ADD_FROG}),
	UNICORN			("Unicorn", 		12, 40, 4, 0, 2, 2, Targeting.FREE_SELECT,	Element.HOLY,		true,	false,	true,	true,	false,	true,	false,	false,	false,	false,	true,	true,	false,	false,	true,	new SkillEffect[] {SkillEffect.HEALING_1X, SkillEffect.ESUNA_EFFECT}),
	IFRIT			("Ifrit", 			18, 40, 4, 0, 2, 2, Targeting.FREE_SELECT,	Element.FIRE,		true,	false,	true,	true,	false,	true,	false,	false,	true,	false,	true,	true,	true,	true,	true,	new SkillEffect[] {SkillEffect.REGULAR_DAMAGE}),
	RAMUH			("Ramuh", 			18, 40, 4, 0, 2, 2, Targeting.FREE_SELECT,	Element.LIGHTNING,	true,	false,	true,	true,	false,	true,	false,	false,	true,	false,	true,	true,	true,	true,	true,	new SkillEffect[] {SkillEffect.REGULAR_DAMAGE}),
	SHIVA			("Shiva",			18, 40, 4, 0, 2, 2, Targeting.FREE_SELECT,	Element.ICE,		true,	false,	true,	true,	false,	true,	false,	false,	true,	false,	true,	true,	true,	true,	true,	new SkillEffect[] {SkillEffect.REGULAR_DAMAGE}),
	KIRIN			("Kirin", 			24,  0, 4, 0, 2, 2, Targeting.FREE_SELECT,	Element.NULL,		true,	false,	true,	true,	false,	true,	false,	false,	false,	false,	true,	true,	false,	false,	true,	new SkillEffect[] {SkillEffect.ADD_REGEN}),
	CARBUNCLE		("Carbuncle", 		12,  0, 4, 0, 2, 2, Targeting.FREE_SELECT,	Element.NULL,		true,	false,	true,	true,	false,	true,	false,	false,	false,	false,	true,	true,	false,	false,	true,	new SkillEffect[] {SkillEffect.ADD_REFLECT}),
	...
	BODY_SLAM		("Body Slam", 		 0, 45, 1, 1, 0, 0, Targeting.FREE_SELECT,	Element.NULL,		true,	false,	true,	true,	true,	false,	false,	true,	true,	false,	false,	true,	false,	false,	true,	new SkillEffect[] {SkillEffect.REGULAR_DAMAGE, SkillEffect.RECOIL_DAMAGE}),
	GREASED_BOLT	("Greased Bolt",	0, 0, 0, 0, 0, 0, null, null, true,	false,	true,	true,	false,	false,	false,	false,	false,	false,	false,	false,	false,	false,	false,	null),
	DOWNSIZE		("Downsize", 		24,  0, 0, 0, 0, 0, Targeting.AS_WEAPON,	Element.AS_WEAPON,	true,	false,	true,	true,	false,	false,	false,	true,	true,	false,	false,	true,	false,	true,	true,	new SkillEffect[] {SkillEffect.HALVE_HP}),
	NURSE			("Nurse", 			0, 0, 0, 0, 0, 0, null, null, true,	false,	true,	true,	false,	false,	false,	false,	false,	false,	false,	false,	false,	false,	false,	null),
	COVER			("Cover", 			 0,  0, 4, 0, 0, 0, Targeting.FREE_SELECT,	Element.NULL,		true,	false,	true,	false,	false,	false,	false,	true,	false,	false,	false,	true,	false,	false,	true,	new SkillEffect[] {SkillEffect.COVER_EFFECT}),
	SUBDUE			("Subdue", 			 0,  0, 0, 0, 0, 0, Targeting.AS_WEAPON,	Element.NULL,		true,	false,	true,	true,	true,	false,	false,	true,	true,	false,	false,	true,	false,	false,	true,	new SkillEffect[] {SkillEffect.SUBDUE_EFFECT}),
	...
	SAINT_CROSS		("Saint Cross", 	0, 0, 0, 0, 0, 0, null, null, true,	false,	true,	true,	false,	false,	false,	false,	false,	false,	false,	false,	false,	false,	false,	null),
	HOLY_BLADE		("Holy Blade",		32, -1, 0, 0, 0, 0, Targeting.AS_WEAPON,	Element.HOLY,		true,	false,	true,	true,	true,	false,	false,	true,	true,	false,	false,	true,	false,	true,	true,	new SkillEffect[] {SkillEffect.DOUBLE_DAMAGE}),
	DEFENSE			("Defense", 		 0,  0, 0, 0, 0, 0, Targeting.FREE_SELECT,	Element.NULL,		true,	false,	true,	true,	false,	true,	false,	true,	false,	false,	false,	true,	false,	false,	true,	new SkillEffect[] {SkillEffect.ADD_DEFENSE}),
	DROP_WEAPON		("Drop Weapon", 	 0,  0, 0, 0, 0, 0, Targeting.AS_WEAPON,	Element.NULL,		true,	false,	true,	true,	false,	false,	false,	true,	false,	false,	false,	true,	false,	false,	true,	new SkillEffect[] {SkillEffect.DROP_WEAPON}),
	...
	AURA			("Aura", 			 0,  0, 0, 0, 0, 0, Targeting.FREE_SELECT,	Element.NULL,		true,	false,	true,	true,	false,	true,	false,	true,	false,	false,	false,	true,	false,	false,	true,	new SkillEffect[] {SkillEffect.ADD_AUTO_LIFE, SkillEffect.ADD_REGEN}),
	EXPERT_GUARD	("Expert Guard", 	 0,  0, 0, 0, 0, 0, Targeting.FREE_SELECT,	Element.NULL,		true,	false,	true,	true,	false,	true,	false,	true,	false,	false,	false,	true,	false,	false,	true,	new SkillEffect[] {SkillEffect.ADD_EXPERT_GUARD}),
	MELTDOWN		("Meltdown", 		0, 0, 0, 0, 0, 0, null, null, true,	false,	true,	true,	false,	false,	false,	false,	false,	false,	false,	false,	false,	false,	false,	null),
	WHIRLWIND		("Whirlwind", 		0, 0, 0, 0, 0, 0, null, null, true,	false,	true,	true,	false,	false,	false,	false,	false,	false,	false,	false,	false,	false,	false,	null),
	...
	AIR_BLAST		("Air Blast", 		0, 0, 0, 0, 0, 0, null, null, true,	false,	true,	true,	false,	false,	false,	false,	false,	false,	false,	false,	false,	false,	false,	null),
	...
	WILD_SWING		("Wild Swing", 		0, 0, 0, 0, 0, 0, null, null, true,	false,	true,	true,	false,	false,	false,	false,	false,	false,	false,	false,	false,	false,	false,	null),
	...
	WARCRY			("Warcry", 			0, 0, 0, 0, 0, 0, null, null, true,	false,	true,	true,	false,	false,	false,	false,	false,	false,	false,	false,	false,	false,	false,	null),
	...
	ICE_BREATH		("Ice Breath", 		0, 0, 0, 0, 0, 0, null, null, true,	false,	true,	true,	false,	false,	false,	false,	false,	false,	false,	false,	false,	false,	false,	null),
	...
	BANGAA_CRY		("Bangaa Cry", 		0, 0, 0, 0, 0, 0, null, null, true,	false,	true,	true,	false,	false,	false,	false,	false,	false,	false,	false,	false,	false,	false,	null),
	...
	SWALLOWTAIL		("Swallowtail", 	0, 0, 0, 0, 0, 0, null, null, true,	false,	true,	true,	false,	false,	false,	false,	false,	false,	false,	false,	false,	false,	false,	null),
	...
	AIM_VITALS		("Aim: Vitals", 	0, 0, 0, 0, 0, 0, null, null, true,	false,	true,	true,	false,	false,	false,	false,	false,	false,	false,	false,	false,	false,	false,	null),
	...
	GOBLIN			("Goblin", 			0, 0, 0, 0, 0, 0, null, null, true,	false,	true,	true,	false,	false,	false,	false,	false,	false,	false,	false,	false,	false,	false,	null),
	FLAN			("Flan", 			0, 0, 0, 0, 0, 0, null, null, true,	false,	true,	true,	false,	false,	false,	false,	false,	false,	false,	false,	false,	false,	false,	null),
	BOMB			("Bomb", 			0, 0, 0, 0, 0, 0, null, null, true,	false,	true,	true,	false,	false,	false,	false,	false,	false,	false,	false,	false,	false,	false,	null),
	DRAGON			("Dragon", 			0, 0, 0, 0, 0, 0, null, null, true,	false,	true,	true,	false,	false,	false,	false,	false,	false,	false,	false,	false,	false,	false,	null),
	LAMIA			("Lamia", 			0, 0, 0, 0, 0, 0, null, null, true,	false,	true,	true,	false,	false,	false,	false,	false,	false,	false,	false,	false,	false,	false,	null),
	BUG				("Bug", 			0, 0, 0, 0, 0, 0, null, null, true,	false,	true,	true,	false,	false,	false,	false,	false,	false,	false,	false,	false,	false,	false,	null),
	PANTHER			("Panther",			0, 0, 0, 0, 0, 0, null, null, true,	false,	true,	true,	false,	false,	false,	false,	false,	false,	false,	false,	false,	false,	false,	null),
	MALBORO			("Malboro", 		0, 0, 0, 0, 0, 0, null, null, true,	false,	true,	true,	false,	false,	false,	false,	false,	false,	false,	false,	false,	false,	false,	null),
	FLOATEYE		("Floateye", 		0, 0, 0, 0, 0, 0, null, null, true,	false,	true,	true,	false,	false,	false,	false,	false,	false,	false,	false,	false,	false,	false,	null),
	...
	ECHO_SCREEN		("Echo Screen", 	0, 0, 0, 0, 0, 0, null, null, true,	false,	true,	true,	false,	false,	false,	false,	false,	false,	false,	false,	false,	false,	false,	null),
	MAIDEN_KISS		("Maiden Kiss", 	0, 0, 0, 0, 0, 0, null, null, true,	false,	true,	true,	false,	false,	false,	false,	false,	false,	false,	false,	false,	false,	false,	null),
	SOFT			("Soft", 			0, 0, 0, 0, 0, 0, null, null, true,	false,	true,	true,	false,	false,	false,	false,	false,	false,	false,	false,	false,	false,	false,	null),
	...
	ANTIDOTE		("Antidote", 		0, 0, 0, 0, 0, 0, null, null, true,	false,	true,	true,	false,	false,	false,	false,	false,	false,	false,	false,	false,	false,	false,	null),
	EYE_DROPS		("Eye Drops", 		0, 0, 0, 0, 0, 0, null, null, true,	false,	true,	true,	false,	false,	false,	false,	false,	false,	false,	false,	false,	false,	false,	null),
	...
	BLOWUP			("Blowup", 			0, 0, 0, 0, 0, 0, null, null, true,	false,	true,	true,	false,	false,	false,	false,	false,	false,	false,	false,	false,	false,	false,	null),
	FLAME_ATTACK	("Flame Attack", 	0, 0, 0, 0, 0, 0, null, null, true,	false,	true,	true,	false,	false,	false,	false,	false,	false,	false,	false,	false,	false,	false,	null),
	CHILL			("Chill", 			0, 0, 0, 0, 0, 0, null, null, true,	false,	true,	true,	false,	false,	false,	false,	false,	false,	false,	false,	false,	false,	false,	null),
	...
	NIGHT			("Night", 			0, 0, 0, 0, 0, 0, null, null, true,	false,	true,	true,	false,	false,	false,	false,	false,	false,	false,	false,	false,	false,	false,	null),
	...
	HAND_SLAP		("Hand Slap", 		 0, 45, 1, 2, 0, 0, Targeting.FREE_SELECT,	Element.NULL,		true,	false,	true,	true,	true,	false,	false,	true,	true,	false,	false,	false,	false,	false,	true,	new SkillEffect[] {SkillEffect.ADD_POISON, SkillEffect.EFF1DEP_ADD_FROG}),
	...
	LV3_DEF_LESS	("LV3 Def-Less", 	0, 0, 0, 0, 0, 0, null, null, true,	false,	true,	true,	false,	false,	false,	false,	false,	false,	false,	false,	false,	false,	false,	null),
	SANDSTORM		("Sandstorm", 		0, 0, 0, 0, 0, 0, null, null, true,	false,	true,	true,	false,	false,	false,	false,	false,	false,	false,	false,	false,	false,	false,	null),
	LV5_DEATH		("LV5 Death", 		0, 0, 0, 0, 0, 0, null, null, true,	false,	true,	true,	false,	false,	false,	false,	false,	false,	false,	false,	false,	false,	false,	null),
