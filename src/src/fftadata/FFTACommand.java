...
public enum FFTACommand implements Serializable
{
	 ...
	 STEAL_H			("Steal",			new FFTASkill[]{FFTASkill.STEAL_ARMOR,	FFTASkill.STEAL_SHIELD,	FFTASkill.STEAL_ACCESS,	FFTASkill.STEAL_HELM,	FFTASkill.STEAL_WEAPON,	FFTASkill.STEAL_GIL,	FFTASkill.STEAL_EXP,	FFTASkill.STEAL_JP,			FFTASkill.STEAL_ABILITY}),
	 ...
	 WHITE_MAGIC_H		("White Magic",		new FFTASkill[]{FFTASkill.CURE,			FFTASkill.CURA,			FFTASkill.CURAGA,		FFTASkill.LIFE,			FFTASkill.ESUNA,		FFTASkill.FULL_LIFE,	FFTASkill.AUTO_LIFE,	FFTASkill.SHELL,			FFTASkill.PROTECT}),
	 BLACK_MAGIC_H		("Black Magic",		new FFTASkill[]{FFTASkill.FIRE,			FFTASkill.FIRA,			FFTASkill.FIRAGA,		FFTASkill.THUNDER,		FFTASkill.THUNDARA,		FFTASkill.THUNDAGA,		FFTASkill.BLIZZARD,		FFTASkill.BLIZZARA,			FFTASkill.BLIZZAGA}),
	 PHANTASM_SKILL_H	("Phantasm Skill",	new FFTASkill[]{FFTASkill.PROMINENCE,	FFTASkill.TEMPEST,		FFTASkill.FREEZEBLINK,	FFTASkill.STAR_CROSS,	FFTASkill.STARDUST,		FFTASkill.DELUGE,		FFTASkill.SOIL_EVIDENCE,FFTASkill.WILD_TORNADO}),
	 ...
	 AIM_H				("Aim",				new FFTASkill[]{FFTASkill.BOOST,		FFTASkill.AIM_LEGS,		FFTASkill.AIM_ARM,		FFTASkill.CUPID,		FFTASkill.BURIAL,		FFTASkill.TAKE_AIM,		FFTASkill.FASTER,		FFTASkill.BLACKOUT}),
	 ...
	 STEAL_M			("Steal",			new FFTASkill[]{FFTASkill.STEAL_ARMOR,	FFTASkill.STEAL_SHIELD,	FFTASkill.STEAL_ACCESS,	FFTASkill.STEAL_HELM,	FFTASkill.STEAL_WEAPON,	FFTASkill.STEAL_GIL,	FFTASkill.STEAL_EXP,	FFTASkill.STEAL_JP,			FFTASkill.STEAL_ABILITY}),
	 ...
	 BLACK_MAGIC_M		("Black Magic",		new FFTASkill[]{FFTASkill.FIRE,			FFTASkill.FIRA,			FFTASkill.FIRAGA,		FFTASkill.THUNDER,		FFTASkill.THUNDARA,		FFTASkill.THUNDAGA,		FFTASkill.BLIZZARD,		FFTASkill.BLIZZARA,			FFTASkill.BLIZZAGA}),
	 TIME_MAGIC_M		("Time Magic",		new FFTASkill[]{FFTASkill.HASTE,		FFTASkill.QUICKEN,		FFTASkill.SLOW,			FFTASkill.REFLECT,		FFTASkill.STOP,			FFTASkill.SILENCE,		FFTASkill.QUARTER,		FFTASkill.DEMI}),
	 
	 WHITE_MAGIC_N		("White Magic",		new FFTASkill[]{FFTASkill.CURE,			FFTASkill.CURA,			FFTASkill.CURAGA,		FFTASkill.LIFE,			FFTASkill.ESUNA,		FFTASkill.FULL_LIFE,	FFTASkill.AUTO_LIFE,	FFTASkill.SHELL,			FFTASkill.PROTECT}),
	 BLACK_MAGIC_N		("Black Magic",		new FFTASkill[]{FFTASkill.FIRE,			FFTASkill.FIRA,			FFTASkill.FIRAGA,		FFTASkill.THUNDER,		FFTASkill.THUNDARA,		FFTASkill.THUNDAGA,		FFTASkill.BLIZZARD,		FFTASkill.BLIZZARA,			FFTASkill.BLIZZAGA}),
	 TIME_MAGIC_N		("Time Magic",		new FFTASkill[]{FFTASkill.HASTE,		FFTASkill.QUICKEN,		FFTASkill.SLOW,			FFTASkill.REFLECT,		FFTASkill.STOP,			FFTASkill.SILENCE,		FFTASkill.QUARTER,		FFTASkill.DEMI}),
	 PHANTASM_SKILL_N	("Phantasm Skill",	new FFTASkill[]{FFTASkill.PROMINENCE,	FFTASkill.TEMPEST,		FFTASkill.FREEZEBLINK,	FFTASkill.STAR_CROSS,	FFTASkill.STARDUST,		FFTASkill.DELUGE,		FFTASkill.SOIL_EVIDENCE,FFTASkill.WILD_TORNADO}),
	 ...
	 WHITE_MAGIC_V		("White Magic",		new FFTASkill[]{FFTASkill.CURE,			FFTASkill.CURA,			FFTASkill.CURAGA,		FFTASkill.LIFE,			FFTASkill.ESUNA,		FFTASkill.FULL_LIFE,	FFTASkill.AUTO_LIFE,	FFTASkill.SHELL,			FFTASkill.PROTECT}),
	 ...
	 AIM_V				("Aim",				new FFTASkill[]{FFTASkill.BOOST,		FFTASkill.AIM_LEGS,		FFTASkill.AIM_ARM,		FFTASkill.CUPID,		FFTASkill.BURIAL,		FFTASkill.TAKE_AIM,		FFTASkill.FASTER,		FFTASkill.BLACKOUT}),
