...
public enum FFTASkill implements Serializable
{
	...
	GREASED_BOLT	("Greased Bolt", 	 0, -1, 0, 0, 0, 0, Targeting.AS_WEAPON,	Element.AS_WEAPON,	true,	false,	true,	true,	true,	false,	true,	true,	true,	false,	false,	true,	false,	false,	true,	new SkillEffect[] {SkillEffect.REGULAR_DAMAGE}),
	...
	NURSE			("Nurse", 			 0, 30, 0, 0, 1, 2, Targeting.SELF_CENTER,	Element.NULL,		true,	false,	true,	true,	false,	true,	false,	true,	false,	false,	false,	true,	false,	false,	true,	new SkillEffect[] {SkillEffect.HEALING_1X, SkillEffect.ESUNA_EFFECT}),
	...
	SAINT_CROSS		("Saint Cross", 	24, 35, 0, 0, 1, 2, Targeting.SELF_CENTER,	Element.HOLY,		true,	false,	true,	true,	true,	false,	false,	true,	true,	false,	false,	true,	false,	true,	true,	new SkillEffect[] {SkillEffect.REGULAR_DAMAGE}),
	...
	MELTDOWN		("Meltdown", 		 0,  0, 0, 0, 1, 2, Targeting.SELF_CENTER,	Element.NULL,		true,	false,	true,	true,	false,	false,	false,	true,	true,	false,	false,	true,	false,	false,	true,	new SkillEffect[] {SkillEffect.USER_HP_DAMAGE, SkillEffect.SELFDESTRUCT}),
